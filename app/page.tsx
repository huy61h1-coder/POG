    ...
    <main className="ops-shell">
      ...
      <div className="ops-body">
        ...
        <section className="ops-content">
          ...
          {tab==="MAP"&&<MapView products={products} matchedLines={productResult.matchedLines||[]} lineConfigs={data.lineConfigs||[]} query={query} canManage={canManage(data.actor.role)} pogPdfCount={data.pogFiles.filter((file)=>file.mimeType==="application/pdf").length} onReanalyzeAll={()=>void reanalyzeAllPogs()} onOpen={(line,side)=>setPogModal({line,side})} onEdit={(lineConfig)=>setLineModal(lineConfig)}/>} 
...
function MapView({products,matchedLines,lineConfigs,query,canManage,pogPdfCount,onReanalyzeAll,onOpen,onEdit}:{products:Product[];matchedLines:string[];lineConfigs:LineConfig[];query:string;canManage:boolean;pogPdfCount:number;onReanalyzeAll:()=>void;onOpen:(line:string,side:"A"|"B")=>void;onEdit:(lineConfig:LineConfig)=>void}) {
