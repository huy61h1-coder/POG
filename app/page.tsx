  ...
  return (
    <main className="ops-shell">
      ...
      <header className="ops-topbar">
        <button className="ops-brand" onClick={()=>setTab("DASHBOARD")}><b>AEON</b><span>FULFILLMENT<br/>SMARTOPS</span></button>
...
function Dashboard({products,logs,totals,onGo}:{products:Product[];logs:Audit[];totals:{outCount:number;lowCount:number;totalLoss:number;expiring:number};onGo:(tab:Tab)=>void}) {
  ...
  return <div><PageHead eyebrow="TRUNG TÂM VẬN HÀNH" title="Tổng quan" subtitle={products.length+" SKU · Tồn kho, thất thoát và hạn dùng được cập nhật đồng bộ."}/>
